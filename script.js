...
(function () {
  ...
  const translations = {
    en: {
      ...
      hero_intro: "A certified state educator trained at Regional Teacher Training Center (RTTC), Kandal, currently pursuing mathematics at CUS, and the creator of KruHub (https://kruhub-47766.firebaseapp.com/). Skilled in utilizing modern AI tools for educational web development and instructional design to make secondary STEM learning intuitive, practical, and engaging.",
      ...
      info_degree_val: "B.Math (CUS) • RTTC Kandal • Foundation Year (CADT Y1)",
      info_languages_lbl: "Languages:",
      info_languages_val: "Khmer (Native) • English (B2) • French (Bilingual Bac)",
      info_interests_lbl: "Interests:",
      info_interests_val: "KruHub Web App, AI for Teaching, STEM Education, GeoGebra",
      ...
      cat_tech_desc: "Strong mathematical and computational foundations from CADT (Linear Algebra, Probability & Statistics, Discrete Math, C Programming) combined with practical use of AI tools to build KruHub and enhance classroom teaching.",
      ...
      sk_python: "C Programming & Discrete Mathematics",
      sk_data: "AI for Education (Teaching Aids & Web Development)",
    ...
    km: {
      ...
      hero_intro: "ខ្ញុំជាគ្រូបង្រៀនក្របខ័ណ្ឌរដ្ឋផ្នែកគណិតវិទ្យា និងរូបវិទ្យា បញ្ចប់ការបណ្តុះបណ្តាលពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល និងកំពុងបន្តរៀនបរិញ្ញាបត្រគណិតវិទ្យានៅ CUS។ ខ្ញុំក៏ជាអ្នកបង្កើតគេហទំព័រ KruHub (https://kruhub-47766.firebaseapp.com/) ដោយចេះប្រើប្រាស់ AI ក្នុងការបង្កើតគេហទំព័រ និងជំនួយដល់ការរៀបចំការបង្រៀន ដើម្បីជួយឱ្យសិស្សរៀនគណិត និងរូបវិទ្យាកាន់តែងាយយល់ និងមានភាពសប្បាយរីករាយ។",
      ...
      about_p1: "ខ្ញុំឈ្មោះ រិន សិទ្ធិពង្ស ជាគ្រូបង្រៀនអនុវិទ្យាល័យ ឯកទេសគណិតវិទ្យា និងរូបវិទ្យា ដែលបានបញ្ចប់ការបណ្តុះបណ្តាលគរុកោសល្យពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល ហើយបច្ចុប្បន្នជាគ្រូបង្រៀនក្របខ័ណ្ឌរដ្ឋនៅអនុវិទ្យាល័យដំណាក់ព្រីង ស្រុកពញាឮ ខេត្តកណ្តាល។ ក្រៅពីការងារបង្រៀនក្នុងថ្នាក់ ខ្ញុំក៏បានចេះប្រើប្រាស់ AI បង្កើតគេហទំព័រ KruHub (https://kruhub-47766.firebaseapp.com/) ដើម្បីជួយសម្រួលដល់លោកគ្រូអ្នកគ្រូក្នុងការកត់វត្តមាន គ្រប់គ្រងពិន្ទុ និងការងាររដ្ឋបាលថ្នាក់រៀនឱ្យកាន់តែរហ័ស។",
      about_p2: "ក្នុងការបង្រៀន ខ្ញុំតែងតែចាត់ទុកសិស្សជាចម្បង ដោយលើកទឹកចិត្តឱ្យពួកគាត់ហ៊ានសួរ ហ៊ានបញ្ចេញមតិ និងអនុវត្តជាក់ស្តែង។ តាមរយៈចំណេះដឹងគណិតវិទ្យាពី CUS និងមុខវិជ្ជាដែលធ្លាប់រៀននៅ CADT (រួមមាន Linear Algebra, ប្រូបាប និងស្ថិតិ, Discrete Math, IT Essentials និងការសរសេរកូដ C) រួមជាមួយការចេះប្រើប្រាស់ឧបករណ៍ AI ទំនើបៗ ខ្ញុំបានបង្កើតគេហទំព័រ KruHub និងបានយកបច្ចេកវិទ្យាមកជំនួយក្នុងការរៀបចំមេរៀន សន្លឹកកិច្ចការ និងគំរូពិសោធន៍ ដើម្បីឱ្យសិស្សងាយយល់ និងចូលចិត្តរៀន។",
      ...
      info_degree_val: "បរិញ្ញាបត្រគណិត (CUS) • គរុកោសល្យភូមិភាគ • ឆ្នាំមូលដ្ឋាន (CADT Y1)",
      info_languages_lbl: "ភាសា:",
      info_languages_val: "ខ្មែរ (កំណើត) • អង់គ្លេស (B2) • បារាំង (ថ្នាក់ពីរភាសា)",
      info_interests_lbl: "ចំណាប់អារម្មណ៍:",
      info_interests_val: "គេហទំព័រ KruHub, ការប្រើ AI ជំនួយការបង្រៀន, ការអប់រំ STEM, កម្មវិធី GeoGebra",
      ...
      cat_tech_desc: "ចំណេះដឹងគ្រឹះគណិតវិទ្យា និងកុំព្យូទ័រពី CADT (ដូចជា Linear Algebra, ស្ថិតិ, Discrete Math, កូដ C) រួមជាមួយការចេះប្រើប្រាស់ AI ក្នុងការបង្កើតគេហទំព័រ KruHub និងជំនួយដល់ការរៀបចំការបង្រៀន។",
      sk_msoffice: "Microsoft Office (Word, Excel, PPT)",
      sk_grades: "ការគ្រប់គ្រង និងគណនាពិន្ទុសិស្ស",
      sk_algo: "ពីជគណិតលីនេអ៊ែរ និងស្ថិតិ (Linear Algebra & Stats)",
      sk_python: "ការសរសេរកូដភាសា C និងគណិតវិទ្យាឌីសគ្រីត",
      sk_data: "ការប្រើប្រាស់ AI ជំនួយការបង្រៀន និងបង្កើតគេហទំព័រ",
