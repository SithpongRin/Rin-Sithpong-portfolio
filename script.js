...
(function () {
  ...
  const translations = {
    en: {
      ...
      hero_role: "Lower Secondary Teacher (Math & Physics) & EdTech Developer | Creator of KruHub",
      ...
      info_role_val: "Lower Secondary Teacher (Math & Physics) & Developer",
    ...
    km: {
      ...
      hero_role: "គ្រូបង្រៀនកម្រិតអនុវិទ្យាល័យ ឯកទេសគណិតវិទ្យា និងរូបវិទ្យា & អ្នកអភិវឌ្ឍន៍បច្ចេកវិទ្យាអប់រំ",
      hero_intro: "ជាគ្រូបង្រៀនក្របខ័ណ្ឌរដ្ឋបញ្ចប់ការបណ្តុះបណ្តាលពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល កំពុងបន្តការសិក្សាថ្នាក់បរិញ្ញាបត្រគណិតវិទ្យា (CUS) និងជាអ្នកបង្កើតគេហទំព័រ KruHub (https://kruhub-47766.firebaseapp.com/) សម្រាប់ជួយដល់ការងារគ្រប់គ្រងថ្នាក់រៀនរបស់លោកគ្រូអ្នកគ្រូ។ ខ្ញុំប្តេជ្ញាលើកកម្ពស់ការអប់រំបែប STEM តាមរយៈវិធីសាស្ត្របង្រៀនទាន់សម័យ និងការអនុវត្តបច្ចេកវិទ្យាឌីជីថល។",
      ...
      about_p1: "ខ្ញុំបាទឈ្មោះ សិទ្ធិពង្ស ជាគ្រូបង្រៀនកម្រិតអនុវិទ្យាល័យ ឯកទេសគណិតវិទ្យា និងរូបវិទ្យា ដែលបានបញ្ចប់ការបណ្តុះបណ្តាលពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល ហើយត្រូវបានតែងតាំងជាគ្រូបង្រៀនក្របខ័ណ្ឌរដ្ឋនៅអនុវិទ្យាល័យដំណាក់ព្រីង ស្រុកពញាឮ ខេត្តកណ្តាល។ ក្រៅពីការបង្រៀន ខ្ញុំបាទជាអ្នកបង្កើតនិងអភិវឌ្ឍគេហទំព័រ KruHub (https://kruhub-47766.firebaseapp.com/) ដែលជាប្រព័ន្ធគ្រប់គ្រងថ្នាក់រៀនឌីជីថលដោយប្រើប្រាស់ Firebase សម្រាប់សម្រួលដល់កិច្ចការលោកគ្រូអ្នកគ្រូ។",
      ...
      info_role_val: "គ្រូបង្រៀនអនុវិទ្យាល័យ (គណិតវិទ្យា & រូបវិទ្យា) & អ្នកអភិវឌ្ឍន៍",
      ...
      info_degree_val: "បរិញ្ញាបត្រគណិត (CUS) • មជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល • ទិន្នន័យ (CADT Y1)",
      info_languages_lbl: "ភាសា:",
      info_languages_val: "ខ្មែរ (កំណើត) • អង់គ្លេស (B2) • បារាំង (ថ្នាក់ពីរភាសា)",
      info_interests_lbl: "ចំណាប់អារម្មណ៍:",
      info_interests_val: "គេហទំព័រ KruHub, ការអប់រំ STEM, GeoGebra, ក្បួនដោះស្រាយ",
      ...
      edu2_desc: "បានបញ្ចប់ការបណ្តុះបណ្តាលគរុកោសល្យវិជ្ជាជីវៈជាតិផ្នែក STEM និងការដឹកនាំថ្នាក់រៀនពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល។ ត្រូវបានតែងតាំងជាគ្រូបង្រៀនរដ្ឋពេញសិទ្ធិនៅអនុវិទ្យាល័យដំណាក់ព្រីង។",
      ...
      proj_kruhub_desc: "ប្រព័ន្ធគ្រប់គ្រងថ្នាក់រៀនតាមគេហទំព័រ បង្កើតនិងអភិវឌ្ឍដោយ រិន សិទ្ធិពង្ស ដោយប្រើប្រាស់ Firebase, JavaScript, HTML5 និង CSS3។ ជួយឱ្យលោកគ្រូអ្នកគ្រូអាចគ្រប់គ្រងបញ្ជីសិស្ស ស្រង់វត្តមានប្រចាំថ្ងៃ បញ្ចូលនិងគណនាពិន្ទុប្រឡង និងបង្កើតការវាយតម្លៃរហ័សយ៉ាងមានប្រសិទ្ធភាព។",
