...
(function () {
  ...
  const translations = {
    en: {
      ...
      hero_intro: "A certified state educator trained at Regional Teacher Training Center (RTTC), Kandal, currently pursuing advanced mathematics at CUS, and the creator of KruHub (https://kruhub-47766.firebaseapp.com/). Passionate about student-centered instruction, digital classroom innovation, and making complex STEM concepts intuitive and engaging.",
      ...
      about_p1: "I am Sithpong, a certified Lower Secondary Teacher in Mathematics and Physics, trained at Regional Teacher Training Center (RTTC), Kandal and officially appointed as a state educator to Damnak Pring Lower Secondary School in Ponhea Lueu, Kandal Province. Beyond traditional classroom teaching, I am the creator and developer of KruHub (https://kruhub-47766.firebaseapp.com/), a specialized web platform built with Firebase to streamline teacher classroom workflows.",
      ...
      info_degree_val: "B.Math (CUS) • RTTC Kandal • Data Science (CADT Y1)",
      info_languages_lbl: "Languages:",
      info_languages_val: "Khmer (Native) • English (B2) • French (Bilingual Bac)",
      info_interests_lbl: "Interests:",
      info_interests_val: "KruHub Web App, STEM Education, GeoGebra, Physics Sim",
      ...
      proj_kruhub_desc: "A full-featured classroom management web application created and developed by Rin Sithpong using Firebase, JavaScript, HTML5, and CSS3. Empowers educators to efficiently manage student rosters, record daily attendance, enter and calculate examination marks, and generate rapid student evaluations.",
    ...
    km: {
      ...
      hero_intro: "ខ្ញុំជាគ្រូបង្រៀនក្របខ័ណ្ឌរដ្ឋផ្នែកគណិតវិទ្យា និងរូបវិទ្យា បញ្ចប់ការបណ្តុះបណ្តាលពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល និងកំពុងបន្តរៀនបរិញ្ញាបត្រគណិតវិទ្យានៅ CUS។ ខ្ញុំក៏ជាអ្នកបង្កើតគេហទំព័រ KruHub (https://kruhub-47766.firebaseapp.com/) សម្រាប់ជួយសម្រួលការងារគ្រូបង្រៀន ព្រមទាំងចូលចិត្តស្រាវជ្រាវវិធីបង្រៀនថ្មីៗ និងការប្រើប្រាស់បច្ចេកវិទ្យា ដើម្បីជួយឱ្យសិស្សរៀនគណិត និងរូបវិទ្យាកាន់តែងាយយល់ និងមានភាពសប្បាយរីករាយ។",
      ...
      about_lead: "បង្រៀនដោយផ្តោតលើការយល់ដឹងពិតប្រាកដរបស់សិស្ស រួមផ្សំជាមួយបច្ចេកវិទ្យាដើម្បីធ្វើឱ្យមេរៀនកាន់តែងាយស្រួលយល់។",
      about_p1: "ខ្ញុំឈ្មោះ រិន សិទ្ធិពង្ស ជាគ្រូបង្រៀនអនុវិទ្យាល័យ ឯកទេសគណិតវិទ្យា និងរូបវិទ្យា ដែលបានបញ្ចប់ការបណ្តុះបណ្តាលគរុកោសល្យពីមជ្ឈមណ្ឌលគរុកោសល្យភូមិភាគខេត្តកណ្តាល ហើយបច្ចុប្បន្នជាគ្រូបង្រៀនក្របខ័ណ្ឌរដ្ឋនៅអនុវិទ្យាល័យដំណាក់ព្រីង ស្រុកពញាឮ ខេត្តកណ្តាល។ ក្រៅពីការងារបង្រៀនក្នុងថ្នាក់ ខ្ញុំក៏បានបង្កើតគេហទំព័រ KruHub (https://kruhub-47766.firebaseapp.com/) ដោយប្រើប្រាស់បច្ចេកវិទ្យា Firebase ដើម្បីជួយសម្រួលដល់លោកគ្រូអ្នកគ្រូក្នុងការកត់វត្តមាន គ្រប់គ្រងពិន្ទុ និងការងាររដ្ឋបាលថ្នាក់រៀនឱ្យកាន់តែរហ័ស។",
      about_p2: "ក្នុងការបង្រៀន ខ្ញុំតែងតែចាត់ទុកសិស្សជាចម្បង ដោយលើកទឹកចិត្តឱ្យពួកគាត់ហ៊ានសួរ ហ៊ានបញ្ចេញមតិ និងអនុវត្តជាក់ស្តែង។ តាមរយៈការបន្តរៀនបរិញ្ញាបត្រគណិតវិទ្យានៅ CUS បូករួមនឹងមូលដ្ឋានគ្រឹះផ្នែកកុំព្យូទ័រពី CADT ខ្ញុំចូលចិត្តយកកម្មវិធីកុំព្យូទ័រ ស្លាយរូបភាព និងគំរូពិសោធន៍មកបង្ហាញក្នុងថ្នាក់ ដើម្បីឱ្យសិស្សមើលឃើញរូបភាពច្បាស់ និងយល់ពីប្រភពនៃរូបមន្តនីមួយៗ មិនមែនគ្រាន់តែទន្ទេញចាំមាត់នោះទេ។",
      about_p3: "ខ្ញុំមានសមត្ថភាពប្រើប្រាស់ភាសាខ្មែរ ភាសាអង់គ្លេស (កម្រិត B2) និងភាសាបារាំង (ដោយសារធ្លាប់រៀនថ្នាក់ពីរភាសាតាំងពីថ្នាក់ទី៧ រហូតដល់ចប់បាក់ឌុប)។ គោលដៅធំបំផុតរបស់ខ្ញុំ គឺចង់បណ្តុះឱ្យសិស្សានុសិស្សស្រឡាញ់ការរៀនសូត្រ មានភាពក្លាហានក្នុងការដោះស្រាយលំហាត់ពិបាកៗ និងមានមូលដ្ឋានគ្រឹះរឹងមាំសម្រាប់បន្តការសិក្សានៅកម្រិតខ្ពស់។",
      ...
      info_degree_val: "បរិញ្ញាបត្រគណិត (CUS) • គរុកោសល្យភូមិភាគ • ទិន្នន័យ (CADT Y1)",
      info_languages_lbl: "ភាសា:",
      info_languages_val: "ខ្មែរ (កំណើត) • អង់គ្លេស (B2) • បារាំង (ថ្នាក់ពីរភាសា)",
      info_interests_lbl: "ចំណាប់អារម្មណ៍:",
      info_interests_val: "គេហទំព័រ KruHub, ការអប់រំ STEM, កម្មវិធី GeoGebra, ការសរសេរកូដ",
      ...
      cat_pedagogy_desc: "វិធីសាស្ត្របង្រៀនសិស្សមជ្ឈមណ្ឌល ការរៀបចំមេរៀន និងការពន្យល់ស្របតាមកម្មវិធីសិក្សាជាតិថ្នាក់ទី ៧ ដល់ ទី ៩។",
      ...
      cat_edtech_desc: "ការប្រើប្រាស់ឧបករណ៍ឌីជីថលដើម្បីបង្កើតបរិយាកាសរៀនសូត្រឱ្យកាន់តែរស់រវើក ទាំងការរៀនក្នុងថ្នាក់ផ្ទាល់ និងការរៀនតាមអនឡាញ។",
      ...
      cat_tech_title: "ជំនាញកុំព្យូទ័រ និងបច្ចេកវិទ្យា",
      cat_tech_desc: "មូលដ្ឋានគ្រឹះផ្នែកកុំព្យូទ័រ និងការសរសេរកូដពី CADT រួមជាមួយការប្រើប្រាស់កម្មវិធីកុំព្យូទ័រសម្រាប់សម្រួលការងារបង្រៀន។",
      sk_msoffice: "Microsoft Office (Word, Excel, PPT)",
      sk_grades: "ការគ្រប់គ្រង និងគណនាពិន្ទុសិស្ស",
      sk_algo: "ក្បួនដោះស្រាយ និងការគិតបែបរៀបចំ (Algorithms)",
      sk_python: "មូលដ្ឋានគ្រឹះសរសេរកូដ (Python / C)",
      sk_data: "ការវិភាគ និងគ្រប់គ្រងទិន្នន័យ",
      sk_web_basics: "ការបង្កើតគេហទំព័រ (HTML/CSS)",

      cat_leadership_title: "ទំនាក់ទំនង និងភាសា",
      cat_leadership_desc: "ទំនាក់ទំនងល្អក្នុងក្រុមការងារ ក្រមសីលធម៌វិជ្ជាជីវៈគ្រូបង្រៀន និងការយកចិត្តទុកដាក់ផ្តល់ការប្រឹក្សាដល់សិស្សានុសិស្ស។",
      sk_km: "ភាសាខ្មែរ: ភាសាកំណើត",
      sk_en: "ភាសាអង់គ្លេស: កម្រិតមធ្យមកម្រិតខ្ពស់ (B2)",
      sk_fr: "ភាសាបារាំង: ថ្នាក់ពីរភាសា (បាក់ឌុបបារាំង)",
      sk_mentor: "ការផ្តល់ប្រឹក្សា និងបំប៉នសិស្ស",
      sk_collab: "ការសហការការងារជាក្រុម និងសីលធម៌វិជ្ជាជីវៈ",
      sk_time: "ការគ្រប់គ្រងពេលវេលា និងផែនការបង្រៀន",
      ...
      exp3_desc: "បង្រៀនបំប៉នសិស្សតាមអនឡាញ (Zoom, Google Meet, Telegram) លើមុខវិជ្ជាគណិតវិទ្យា និងរូបវិទ្យា។ បានចងក្រងវិញ្ញាសា លំហាត់គន្លឹះ និងស្លាយពន្យល់មេរៀន ដើម្បីជួយសិស្សពង្រឹងសមត្ថភាព និងត្រៀមប្រឡងបញ្ចប់ឆ្នាំ។",
      ...
      edu3_desc: "បានសិក្សាមូលដ្ឋានគ្រឹះផ្នែកកុំព្យូទ័រ ក្បួនដោះស្រាយ (Algorithms) ការសរសេរកូដ និងការគ្រប់គ្រងទិន្នន័យ។",
      ...
      proj_kruhub_desc: "គេហទំព័រគ្រប់គ្រងថ្នាក់រៀនដែលខ្ញុំបង្កើត និងអភិវឌ្ឍឡើងដោយផ្ទាល់ ដោយប្រើ Firebase, JavaScript, HTML5 និង CSS3។ គេហទំព័រនេះជួយឱ្យលោកគ្រូអ្នកគ្រូងាយស្រួលគ្រប់គ្រងបញ្ជីឈ្មោះសិស្ស ស្រង់វត្តមានប្រចាំថ្ងៃ បញ្ចូលនិងគណនាពិន្ទុប្រចាំខែដោយស្វ័យប្រវត្តិ ចំណេញពេលវេលាច្រើនក្នុងការងាររដ្ឋបាលថ្នាក់។",
      ...
      proj2_badge: "ធនធានបង្រៀន",
      proj2_title: "ធនាគារវិញ្ញាសា និងសន្លឹកកិច្ចការគណិតវិទ្យាអនុវិទ្យាល័យ",
      proj2_desc: "ការចងក្រងកម្រងលំហាត់ វិញ្ញាសាប្រឡង និងដំណោះស្រាយលម្អិត ស្របតាមកម្មវិធីសិក្សាជាតិថ្នាក់ទី ៧ ដល់ ទី ៩ សម្រាប់ឱ្យសិស្សរៀនអនុវត្ត និងត្រៀមប្រឡង។",
      ...
      contact_intro: "ប្រសិនបើលោកអ្នកមានបំណងពិភាក្សាលើការបង្រៀនមុខវិជ្ជា STEM ការរៀបចំឯកសារគរុកោសល្យ ឬកិច្ចសហការផ្សេងៗ សូមទាក់ទងមកខ្ញុំបាទតាមរយៈព័ត៌មានខាងក្រោម។",
      ...
      // Footer
      footer_bio: "គ្រូបង្រៀនអនុវិទ្យាល័យ ឯកទេសគណិតវិទ្យា និងរូបវិទ្យា។ ស្រឡាញ់វិជ្ជាជីវៈបង្រៀន និងចូលចិត្តប្រើប្រាស់បច្ចេកវិទ្យាដើម្បីជួយឱ្យការរៀនសូត្ររបស់សិស្សកាន់តែប្រសើរឡើង។",
