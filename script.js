...
(function () {
  ...
  const translations = {
    en: {
      ...
      cat_tech_desc: "Solid foundation in mathematics and computing from CADT, combined with practical use of AI tools to build KruHub and streamline everyday teaching.",
      ...
      sk_data: "AI for Education & Teaching Aids",
    ...
    km: {
      ...
      cat_tech_desc: "មានមូលដ្ឋានគ្រឹះគណិតវិទ្យា និងកុំព្យូទ័រពីរៀននៅ CADT ព្រមទាំងចេះប្រើប្រាស់ AI មកជួយសម្រួលដល់ការងារបង្រៀន និងបង្កើតគេហទំព័រ KruHub។",
      ...
      sk_data: "ការប្រើប្រាស់ AI ជំនួយការបង្រៀន",
